...
const Speak = {
  ...
  init(){
    const pick=()=>{
      ...
      this.voice = vs.find(v=>v.lang==="el-GR") || vs.find(v=>v.lang.startsWith("el")) || null;
    };
    pick();
...
document.getElementById("bigClose").onclick=()=>document.getElementById("bigcard").hidden=true;
